...
const Navigate = (props: { theme: ThemeType; toggleTheme: () => void }) => {
  ...
  return (
    <nav className="bg-gray-900 dark:bg-gray-100 text-white dark:text-black py-1.5 grid lg:grid-cols-4 sm:grid-cols-2 gap-1 w-3/10 mx-auto lg:my-5 sm:my-1 place-items-center rounded-3xl">
      <div
